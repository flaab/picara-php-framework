...
<h1 class="display-4"><?= _('Administration Tasks') ?></h1>
...
<? if(is_array($tasks) && count($tasks) > 0): ?>
    ...
    <div class="card mb-3">
        <div class="card-body">
        <a href="admin/runtask/<?= $name ?>" class="btn btn-primary float-right align-middle btn-lg mt-2"><strong><?= _('RUN TASK') ?></strong></a>
