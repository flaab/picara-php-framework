    ...
    <div class="card-body">
        <form action="<?= $link['controller'] ?>/login" method="POST">
            <div class="form-group row">
                <label for="email_address" class="col-md-4 col-form-label text-md-right"><?= _('Username') ?></label>
                <div class="col-md-6">
            ...
            <div class="col-md-6 offset-md-4">
                <button type="submit" name="submit" class="btn btn-primary"><?= _('Login') ?></button>
            </div>
        </form>
    </div>
</div>
