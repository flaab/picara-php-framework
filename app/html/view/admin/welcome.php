...
<div class="row">
    <div class="col-md-6">
        ...
        <h3 class="mt-4 mb-3">Add or edit users</h3>
        <ul>
        <li>Edit the file <i><?= USERCONFIG ?>adminusers.php</i></li>
        </ul>
        ...
        <h3 class="mt-4 mb-3">Create an admin task</h3>
        <ul>    
        ...
        <h3 class="mt-4 mb-3">Create a model action</h3>
        <ul>    
        <li>Add a method to <i><?= USERLIB ?>yourmodel.php</i></li>
