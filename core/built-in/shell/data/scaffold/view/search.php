<h1 class="mb-3"><?= $modeldisplay ?> search &nbsp; <small class="text-muted h5">Searching for "<?= $nice_search ?>"</small></h1>
        ...
        <div class="container mb-5">
            <div class="row"> 
                ...
                <div class="col-7">
                    ...
                    <input type="submit" name="change_elements" value="Go"  class="btn btn-primary my-1">
                    </form>
                </div>
                <!-- End order form -->
                ...
                <div class="col-5">
                    <form action="<?= $pagination['base_link'] . $pagination['page'] ?>" target="_blank" method="post" class="form-inline ml-auto">
                        ...
                        <input type="submit" name="export" value="Go" class="btn btn-primary my-1">
                    </form>
                </div>
                <!-- End export form -->
            </div>
