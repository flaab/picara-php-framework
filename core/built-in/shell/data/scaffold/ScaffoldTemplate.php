...
class Scaffold_<modelname>WebController extends MyAdminController
{
    ...
    */ 
    var $before_action = array('load_config');
	...
	*/
	...
	public function index($page = 1)
    {
        ...
        $this->_interact_order();
	 	...
	 	// Put window title
	 	$this->appendTitle('Scaffold ' . CONNECTOR . $this->config->display ." list");
    ...
    */
    ...
    public function view($id)
    {
        ...
        $this->setTitle(TITLE . CONNECTOR . "Scaffold ". CONNECTOR . $this->config->display . CONNECTOR . "View");
        $this->set('modelname', $this->model);
        $this->set('modeldisplay', $this->config->display);
	    $this->set('noindex', true);
    ...
    */
    ...
    public function search($search = NULL, $page = 1)
    {
        ...
        $this->_interact_order();
	 	...
	 	// Put window title
	 	$this->appendTitle('Scaffold ' . CONNECTOR . $this->config->display . CONNECTOR . 'Searching "'. $nice_search .'"');
	    $this->set('noindex', true);
	...
	*/
	...
	{
        // Sets window title
		$this->setTitle(TITLE . CONNECTOR . "Scaffold " . CONNECTOR . $this->config->display . CONNECTOR . "Create");
	    $this->set('noindex', true);
	...
	*/
	...
	{
		// Window title and modelname
        $this->setTitle(TITLE . CONNECTOR . "Scaffold ". CONNECTOR . $this->config->display . CONNECTOR . "Edit");
        $this->set('modelname', $this->model);
        $this->set('modeldisplay', $this->config->display);
	    $this->set('noindex', true);
        ...
        $this->set('extra_images', $this->config->images->extra->enabled);
    ...
    */
    ...
    {
	 	// Put window title
	 	$this->appendTitle('Scaffold ' . CONNECTOR . $this->config->display . CONNECTOR . 'File blocks' . CONNECTOR . ucfirst($block));
	    $this->set('noindex', true);
    ...
    */
    ...
    public function by($model, $value, $page = 1)
    {
        ...
        $this->_interact_order();
	 	...
	 	// Put window title
	 	$this->appendTitle('Scaffold ' . CONNECTOR . $this->config->display . CONNECTOR . 'By '. ucfirst($model));
	    $this->set('noindex', true);
    ...
    */
    ...
    {
	 	// Put window title
	 	$this->appendTitle('Scaffold ' . CONNECTOR . $this->config->display . CONNECTOR . 'Extra images');
	    $this->set('noindex', true);

        // If no extra images allowed
        if($this->config->images->extra->enabled != true)
    ...
    */
    ...
    {
        $this->config = $this->metadata->config->get($this->model);
    ...
    */
    ...
    private function _interact_order()
    {
        ...
        {
            $this->config->pagination->direction = $_POST['orientation'];
            $this->config->pagination->elements = $_POST['elements'];
            if(isset($_POST['order']))  $this->config->pagination->order = $_POST['order'];
    ...
    */
    ...
    private function _export($collection, $format)
    {
        ...
        // View and title
	 	$this->appendTitle('Scaffold ' . CONNECTOR . $this->config->display . CONNECTOR . 'Export');
    }
    ...
    */
    public function action($id, $actionname)
    {
        ...
        $this->set('name',          $object->model_actions[$actionname]['name']);
        $this->set('description',   $object->model_actions[$actionname]['description']);
        
        // Window title and modelname
        $this->setTitle(TITLE . CONNECTOR . "Scaffold ". CONNECTOR . $this->config->display . CONNECTOR . 
